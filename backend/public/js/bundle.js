...
function createAlert(status, msg) {
  var html = "<div class=\"alert alert--".concat(status, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', html);
}

var _default = createAlert;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (data.status === 'success') {
              (0, _alert.default)('success', 'Login successfully!!');
              setTimeout(function () {
                location.assign('/');
              }, 1000);
            } else {
              (0, _alert.default)('error', data.message); // console.log(data);
            }
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, newPassword, confirmPassword) {
    var data, response;
...
if ($('.login-form')) {
  ...
  $('.login-form').addEventListener('submit', /*#__PURE__*/function () {
...
var infoForm = $('.form-user-data');
var passwordForm = $('.form-user-settings');
...
if (passwordForm) {
  passwordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var password, newPassword, confirmPassword, result;
